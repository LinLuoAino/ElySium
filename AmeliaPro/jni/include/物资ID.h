...
inline string tou(int 头)
{
    ...
    // 一
    else if (头 == 502001 || 头 == 502004 || 头 == 502101 || 头 == 9804001)
    {
        StateName = "一";
    }
    // 二
    else if (头 == 502002 || 头 == 502005 || 头 == 502102 || 头 == 9804002)
    {
        StateName = "二";
    }
    // 三
    else if (头 == 502003 || 头 == 502006 || 头 == 502103 || 头 == 9804003)
    {
        StateName = "三";
    }
    // 四
    else if (头 == 502104 || 头 == 502107 || 头 == 502110 || 头 == 9804021 || 头 == 9804004 || 头 == 9804005 || 头 == 9804006)
    {
        StateName = "四";
    }
    // 五
    else if (头 == 502105 || 头 == 502111 || 头 == 502108 || 头 == 9804022 || 头 == 9804007 || 头 == 9804008 || 头 == 9804009)
    {
        StateName = "五";
    }
    // 六
    else if (头 == 502106 || 头 == 502109 || 头 == 502112 ||
             头 == 9804023 || 头 == 9804010 || 头 == 9804011 || 头 == 9804012)
    {
        StateName = "六";
    }
    // 七
    else if (头 == 9804024 || 头 == 9804013 ||
             头 == 9804014 || 头 == 9804015)
    {
        StateName = "七";
    }
    // 金头
    else if (头 == 9804017 || 头 == 9804018 || 头 == 9804019 || 头 == 9804025)
    {
        StateName = "金";
    }
    // 夜
...
inline string jia(int 甲)
{
    ...
    // 一
    else if (甲 == 503001 || 甲 == 503004 || 甲 == 503101 || 甲 == 9805001)
    {
        StateName = "一";
    }
    // 二
    else if (甲 == 503002 || 甲 == 503005 || 甲 == 503102 || 甲 == 9805002)
    {
        StateName = "二";
    }
    // 三
    else if (甲 == 503003 || 甲 == 503006 || 甲 == 503103 || 甲 == 9805003)
    {
        StateName = "三";
    }
    // 四 (包含所有4级防弹衣及变种)
    else if (甲 == 503104 || 甲 == 503107 || 甲 == 503110 ||
             甲 == 9805004 || 甲 == 9805005 || 甲 == 9805006 ||
             甲 == 9805021 || 甲 == 9805022 || 甲 == 9805023 ||
             甲 == 9805036 || 甲 == 9805041)
    {
        StateName = "四";
    }
    // 五 (包含所有5级防弹衣及变种)
    else if (甲 == 503105 || 甲 == 503108 || 甲 == 503111 ||
             甲 == 9805007 || 甲 == 9805008 || 甲 == 9805009 ||
             甲 == 9805024 || 甲 == 9805025 || 甲 == 9805026 ||
             甲 == 9805037 || 甲 == 9805042)
    {
        StateName = "五";
    }
    // 六 (包含所有6级防弹衣及变种)
    else if (甲 == 503106 || 甲 == 503109 || 甲 == 503112 ||
             甲 == 9805010 || 甲 == 9805011 || 甲 == 9805012 ||
             甲 == 9805027 || 甲 == 9805028 || 甲 == 9805029 ||
             甲 == 9805038 || 甲 == 9805043)
    {
        StateName = "六";
    }
    // 七 (包含所有7级防弹衣及变种)
    else if (甲 == 9805013 || 甲 == 9805014 || 甲 == 9805015 ||
             甲 == 9805030 || 甲 == 9805031 || 甲 == 9805032 ||
             甲 == 9805098 || 甲 == 9805099 || 甲 == 9805039 || 甲 == 9805044)
    {
        StateName = "七";
    }
    // 金甲
    else if (甲 == 9805016 || 甲 == 9805017 || 甲 == 9805018 || 甲 == 9805033 || 甲 == 9805034 || 甲 == 9805035 || 甲 == 9805040 || 甲 == 9805045)
    {
        StateName = "金";
    }
    // 威尔
    else if (甲 == 9805100 || 甲 == 9805101 || 甲 == 9805102 || 甲 == 9805103)
    {
        StateName = "威";
    }
    // 特劳斯
    else if (甲 == 9805094 || 甲 == 9805095 || 甲 == 9805096 || 甲 == 9805097)
    {
        StateName = "特";
    }
    // 机
...
inline string bao(int 包)
{
    ...
    // 一
    else if (包 == 501001 || 包 == 501004 || 包 == 501101 || 包 == 9806001)
    {
        StateName = "一";
    }
    // 二
    else if (包 == 501002 || 包 == 501005 || 包 == 501102 || 包 == 9806002)
    {
        StateName = "二";
    }
    // 三
    else if (包 == 501003 || 包 == 501006 || 包 == 501103 || 包 == 9806003)
    {
        StateName = "三";
    }
    // 四 (包含所有4级背包及变种)
    else if (包 == 501104 || 包 == 501107 || 包 == 501110 ||
             包 == 9806004 || 包 == 9806005 || 包 == 9806006 ||
             包 == 9806019)
    {
        StateName = "四";
    }
    // 五 (包含所有5级背包及变种)
    else if (包 == 501105 || 包 == 501108 || 包 == 501111 ||
             包 == 9806007 || 包 == 9806008 || 包 == 9806009 ||
             包 == 9806020)
    {
        StateName = "五";
    }
    // 六 (包含所有6级背包及变种)
    else if (包 == 501106 || 包 == 501109 || 包 == 501112 ||
             包 == 9806010 || 包 == 9806011 || 包 == 9806012 ||
             包 == 9806021)
    {
        StateName = "六";
    }
    // 七 (包含所有7级背包及变种)
    else if (包 == 9806013 || 包 == 9806014 || 包 == 9806015 ||
             包 == 9806016 || 包 == 9806017 || 包 == 9806018 ||
             包 == 9806022 || 包 == 9806023 ||
             包 == 9806100 || 包 == 9806101)
    {
        StateName = "七";
    ...
    // 金包
        ...
        包 == 9806016 || 包 == 9806017 || 包 == 9806018 || 包 == 9806023)
    {
        StateName = "金";
    }
    return StateName;
...
inline const char *GetItems(int Id)
{
    switch (Id)
    {
        ...
        case 101012: return "蜜突击步枪";

        // 连狙
        case 103009: return "SLR射手步枪";
        case 103005: return "VSS射手步枪";
        case 103006: return "Mini14射手步枪";
        case 103010: return "QBU射手步枪";
        case 103004: return "SKS射手步枪";
        case 103007: return "MK14射手步枪";
        case 103014: return "MK20-H射手步枪";
        case 103013: return "M417射手步枪";

        // 狙击枪
        case 103012: return "AMR狙击枪";
        case 103003: return "AWM狙击枪";
        case 103002: return "M24狙击枪";
        case 103011: return "莫甘娜辛狙击枪";
        case 103001: return "Kar98K狙击枪";
        case 103008: return "Win94狙击枪";
        ...
        case 100103: return "PP-19";
        case 102007: return "MP5K";
        case 102002: return "UMP-45";
        ...
        // 武器配件（弹夹、枪口、握把等）
        case 204011: return "[步枪]扩容弹夹";
        case 204012: return "[步枪]快速弹夹";
        case 204013: return "[步枪]快速扩容弹夹";
        case 204008: return "[狙击]扩容弹夹";
        case 204007: return "[狙击]快速弹夹";
        case 204009: return "[狙击]快速扩容弹夹";
        case 204004: return "[冲锋]扩容弹夹";
        case 204005: return "[冲锋]快速弹夹";
        case 204006: return "[冲锋]快速扩容弹夹";
        case 201009: return "[步枪]补偿器";
        case 201010: return "[步枪]消焰器";
        case 201011: return "[步枪]消音器";
        case 201003: return "[狙击]补偿器";
        case 201005: return "[狙击]消焰器";
        case 201007: return "[狙击]消音器";
        case 201002: return "[冲锋]补偿器";
        case 201004: return "[冲锋]消焰器";
        case 201006: return "[冲锋]消音器";
        case 202006: return "拇指握把";
        case 202001: return "直角前握把";
        case 202002: return "垂直握把";
        case 202004: return "轻型握把";
        case 202005: return "半截式握把";
        case 202007: return "激光瞄准器";
        case 201012: return "鸭嘴枪口(霰弹枪)";
        case 201001: return "霰弹枪收束器";
        case 205002: return "战术枪托(步枪, 冲锋枪, 机枪)";
        case 204014: return "子弹袋(狙击枪, 霰弹枪)";
        case 205001: return "枪托(Micro UZI)";
        case 205011: return "撞火枪托";
        case 204017: return "霰弹快速装填器";
        case 205003: return "托腮板(狙击枪)";
        case 205004: return "箭袋(十字弩)";

        // 背包
        case 501001: return "一级包";
        case 501002: return "二级包";
        case 501003: return "三级包";

        // 防具（护甲、头盔、吉利服）
        case 503001: return "一级甲";
        case 503002: return "二级甲";
        case 503003: return "三级甲";
        case 403045: return "吉利服";
        case 502001: return "一级头";
        case 502002: return "二级头";
        case 502003: return "三级头";

        // 瞄准镜
        case 203001: return "红点瞄准镜";
        case 203002: return "全息瞄准镜";
        case 203003: return "2倍瞄准镜";
        case 203014: return "3倍瞄准镜";
        case 203004: return "4倍瞄准镜";
        case 203015: return "6倍瞄准镜";
        case 203005: return "8倍瞄准镜";
        case 203018: return "侧边瞄准镜";
        ...
        // 药品
        case 601004: return "绷带";
        case 601005: return "急救包";
        case 601006: return "医疗箱";
        case 3001032: return "能量饮料";
        case 601002: return "肾上腺素";
        case 601003: return "止痛药";
    case 9801001:
        return "卧底证";
        break;
    case 9801002:
