...
#endif
constexpr uint64_t onn = 0x5A5A5A5A5A5A5A5AULL;
...
constexpr uint64_t onnhhhiiii(uint64_t value, uint64_t key = onn)
{
	return value ^ key;
}

constexpr uint64_t onnhhh(uint64_t encrypted_value, uint64_t key = onn)
{
