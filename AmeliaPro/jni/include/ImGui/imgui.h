...
#endif
// 1.
NLOHMANN_DEFINE_TYPE_INTRUSIVE(ImVec4, x, y, z, w)
...
namespace ImGui
{
    ...
    IMGUI_API void          ImageRotation(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImU32 tint_col, float speed);//旋转图像
...
// 2.
NLOHMANN_DEFINE_TYPE_INTRUSIVE(ImColor, Value)
};
