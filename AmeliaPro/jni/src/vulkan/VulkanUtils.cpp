...
#include <vulkan/vulkan_android.h>  // 必须添加这个！包含 Android 特定的 Vulkan 定义
#include "stb_image.h"
...
void SetupVulkanWindow(ANativeWindow *window, int width, int height) {
    ...
    VkAndroidSurfaceCreateInfoKHR createInfo = {
        ...
        .pNext = nullptr,
        .flags = 0,
        .window = (ANativeWindow*)window  // 确保 window 是 ANativeWindow* 类型
    };
...
void FrameRender(ImDrawData *draw_data) {
    ...
    {
        //透明 默认已经�?�?        //memset(wd->ClearValue.color.float32, 0, sizeof(wd->ClearValue.color.float32));
